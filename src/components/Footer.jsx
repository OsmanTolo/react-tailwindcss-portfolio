...
const Footer = () => {
  return (
    <footer className='flex flex-col justify-between sm:flex-row sm:justify-between items-center gap-2 text-xs sm:text-sm py-8'>
      <p>Design & Built by Osman Dumbuya</p>
      <ul className='flex gap-4 text-blue'>
        <li>
          <a
            href='https://www.linkedin.com/in/osman-dumbuya-148581108/'
            className='opacity-60 hover:opacity-100 flex gap-2 items-center justify-center'
            target='_blank'
            rel='noreferrer'
          >
            <svg
